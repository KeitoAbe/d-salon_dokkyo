(function() {
  ...
  const question = [
    {
      text: "獨協大学応援歌の作曲者は誰か？",
      choice: ["野田隆造", "谷川正秋", "小池辰雄", "村田和人"],
      ansewer: "野田隆造"
    },
    {
      text: "獨協大学キャンパスソングの作詞者は誰か？",
      choice: ["小椋佳","嶋崎千秋", "村田和人", "谷川正秋"],
      ansewer: "嶋崎千秋"
    },
    {
      text: "獨協大学の前身である獨逸学協会会長の総裁は誰か？",
      choice: ["天野貞祐", "西周", "桂太郎", "北白川宮能久親王"],
      ansewer: "北白川宮能久親王"
    },
    {
      text: "獨逸学協会は何を目的に設立された団体か？",
      choice: ["日本の民族としての独立", "ドイツ文化の移植", "西洋文化の受容", "戦後日本の復興"],
      ansewer: "ドイツ文化の移植"
    },
    {
      text: "獨協大学の学科として最も設置の早かったものは次のうちどれか？",
      choice: ["経営学科", "フランス語学科", "経済学科", "法律学科"],
      ansewer: "経済学科"
    },
  ];
