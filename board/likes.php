...
if ($mysqli->connect_errno) {
  ...
  // いいねしているユーザーを取得
  $sql = "SELECT * FROM likes join user on likes.user_number = user.user_number WHERE id = $message_id ";
...
<head>
  ...
  <link rel='stylesheet' href='css/likes.css' type='text/css' media='all' />
        ...
        <?php if (!empty($likes)) { ?>
          <?php foreach ($likes as $value) { ?>
            <div class="twitter__block">
              <a href="profile.php?user_number=<?php echo $value['user_number']; ?>"></a>
              <figure>
