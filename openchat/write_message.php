...
if ($token === $_SESSION['chat_token']) {
	...
	if ($mysqli->connect_errno) {
		...
		if (!isset($_POST['reply_id'])) {
			// データを登録するSQL作成
			$sql = "INSERT INTO openchat (message, post_date, post_time, no, user_number) VALUES ('$message', '$now_date', '$now_time', '$no', '$user_number')";
		} else {
			...
			$sql = "INSERT INTO openchat (message, post_date, post_time, no, user_number, reply_user, reply_to, reply_to_message, reply_id) VALUES ('$message', '$now_date', '$now_time', '$no', '$user_number', '$reply_user', '$reply_to', '$reply_to_message', '$reply_id')";
		}
		// データを登録
