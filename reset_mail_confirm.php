...
if (!preg_match($pattern, $_POST['user_id'] )) {
  ...
  //メール送信
  $to = $mail_address;
  $subject = "d-salon パスワードの再設定";
  $message = "以下のURLよりパスワードの再設定をお願いします。\r\n\r\nhttps://d-salon.jp/reset.php?pass_reset=$pass_reset\r\n\r\n------------------------------\r\n獨協大学 堀江ゼミd-salon制作班\r\ndsalon.dokkyo@gmail.com\r\nhttps://d-salon.jp/";
    ...
    <div class="t_container">
      ...
      <div class="twitter__container" id="container">
        <div class="container">
          ...
          <p>あなたのメールアドレス：<b><?php echo $mail_address; ?></b>へ確認メールを送信しました。<br>メールの案内に従って、パスワードの再設定をお願いします。</p>
